...
\subsection{\parbox{0.75\linewidth}{\large $\AdS_3$ Black holes with Virasoro hair} \hfill \large{Dec 2020 -- Present}}
\hspace{0.01\linewidth}
\parbox{0.88\linewidth}{
    {\small With Dr. Ayan Mukhopadhyay\footnotemark[1] and Tanay Kibe\footnotemark[2] \\
    Exploring three-dimensional Banados geometries with Virasoro hair. Currently trying to reproduce Hawking's calculation in the geometrical optics limit.}
}
...
\subsection{\parbox{0.75\linewidth}{\large On the IR triangle (Reading)} \hfill \large{Winter 2018/19}}
\hspace{0.01\linewidth}
\parbox{0.88\linewidth}{
